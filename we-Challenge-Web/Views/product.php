...
<div class="content-grid" style="transform: translate(368px, 0px); transition: transform 0.4s ease-in-out 0s;">
    ...
    <div class="section-banner">
      <!-- SECTION BANNER ICON -->
      <img class="section-banner-icon" src="/public/img/banner/marketplace-icon.png" alt="marketplace-icon">
      <!-- /SECTION BANNER ICON -->
    ...
    <div class="section-header">
      ...
      <div class="section-header-info">
        <!-- SECTION PRETITLE -->
        <p class="section-pretitle">Provided by : <?=$product->getCompany()->name?></p>
        <!-- /SECTION PRETITLE -->
          ...
          <div id="product-box-slider-items" class="slider-panel-slides">
            ...
            <div class="slider-panel-slide">
              ...
              <figure class="slider-panel-slide-image liquid">
                <img src="<?=$product->image?>" alt="item-10">
              </figure>
              <!-- /SLIDER PANEL SLIDE IMAGE -->
            </div>
          </div>
      ...
      <div class="marketplace-sidebar">
        ...
        <div class="sidebar-box">
          ...
          <div class="sidebar-box-items">
            <!-- PRICE TITLE -->
            <p class="price-title big"><span class="currency">CCoin</span> <?=$product->price?></p>
            <!-- /PRICE TITLE -->
            ...
            <!-- BUTTON -->
            <form method="POST">
                <button class="button primary">Buy Product!</button>
            </form>
            <!-- /BUTTON -->
          </div>
          <!-- /SIDEBAR BOX ITEMS -->
