...
<body>
  ...
  <div class="error-section">
    ...
    <div class="error-section-info">
      ...
      <!-- ERROR SECTION TEXT -->
      <p class="error-section-text">If the problem persists, please send us an email to our support team at <a href="#">lahbib.safa18@gmail.com</a></p>
      <!-- /ERROR SECTION TEXT -->

      <!-- BUTTON -->
      <a class="button medium primary" href="/home">Go Back</a>
      <!-- /BUTTON -->
    </div>
    <!-- /ERROR SECTION INFO -->
  </div>
