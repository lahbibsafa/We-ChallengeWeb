...
<div class="content-grid" style="transform: translate(368px, 0px); transition: transform 0.4s ease-in-out 0s;">
    <div class="section-header">
      ...
      <div class="section-header-info">
        <!-- SECTION PRETITLE -->
        <p class="section-pretitle">Provided by : <?=$challenge->getCompany()->name?></p>
        <!-- /SECTION PRETITLE -->
  
        <!-- SECTION TITLE -->
        <h2 class="section-title pinned"><?=$challenge->title?></h2>
        <!-- /SECTION TITLE -->
      </div>
      <!-- /SECTION HEADER INFO -->
    </div>
        ...
        <div class="slider-panel">
          ...
          <div id="product-box-slider-items" class="slider-panel-slides">
            ...
            <div class="slider-panel-slide">
              ...
              <figure class="slider-panel-slide-image liquid">
                <img src="<?=$challenge->cover?>" alt="item-10">
              </figure>
              <!-- /SLIDER PANEL SLIDE IMAGE -->
            </div>
          </div>
          ...
          <div class="tab-box-items">
            ...
            <div class="tab-box-item" style="display: block;">
              ...
              <p  class="tab-box-item-paragraph"><?=$challenge->description?></p>
              </div>
            </div>
            </div>
        </div>
      ...
      <div class="marketplace-sidebar">
        ...
        <div class="sidebar-box">
          ...
          <div class="sidebar-box-items">
            <!-- PRICE TITLE -->
            <p class="price-title big"><span class="currency">CCoin</span> <?=$challenge->prize?></p>
            <!-- /PRICE TITLE -->
            <!-- BUTTON -->
            <?php
                if (time() < strtotime($challenge->deadline)) {
                    if($user->joined($challenge->idChallenge)) {
                        if($user->hasSubmission($challenge->idChallenge)){
                            ?>
                            <p class="primary">Already submitted</p>
                            <?php
                        }else {
            ?>
                <a class="button primary" href="/submit/<?=$challenge->idChallenge?>">Submit Proof of Work</a>
            <?php
                  } } else {
            ?>
            <form method="POST">
                <button class="button primary">Join Challenge!</button>
            </form>
            <?php
            }
                }
