...
<div class="content-grid" style="transform: translate(368px, 0px); transition: transform 0.4s ease-in-out 0s;">
    <div class="section-banner" style="">
        ...
        <p class="section-banner-title"><?=$challenge->title?></p>
        <!-- /SECTION BANNER TITLE -->
        <!-- SECTION BANNER TEXT -->
        <p class="section-banner-text">We are happy to see you here, this prove that you are one of those who choose to stand for our planet!</p>
        <!-- /SECTION BANNER TEXT -->
    </div>
    <div class="widget-box">
        <div class="widget-box-title">Submit your proof of work</div>
            ...
            <form method="POST" class="form">
                <div class="form-row split">
                  ...
                  <div class="form-item">
                    ...
                    <div class="form-input small active">
                      <label for="submit-name">Title</label>
                      <input type="text" id="submit-name" name="title" value="">
                    </div>
                    <!-- /FORM INPUT -->
                  </div>
                  <!-- /FORM ITEM -->
                ...
                <div class="form-row split">
                  ...
                  <div class="form-input small full">
                      <textarea id="submit-description" name="description" placeholder="Write a little description about your contribution..."></textarea>
                    </div>
                  </div>
                  <!-- /FORM ITEM -->
                ...
                <div class="form-row split">
                  ...
                  <div class="form-item">
                    <!-- FORM INPUT -->
                    <div class="form-input small active">
                      <label for="submit-url">URL of youtube video</label>
                      <input type="text" id="submit-url" name="proof" value="">
                    </div>
                    <!-- /FORM INPUT -->
                  </div>
                  <!-- /FORM ITEM -->
                ...
                <div class="form-row split">
                  <!-- FORM ITEM -->
                  <div class="form-item">
                    <button class="button primary">Submit your work</button>
                  </div>
                  <!-- /FORM ITEM -->
