...
<div class="content-grid" style="transform: translate(368px, 0px); transition: transform 0.4s ease-in-out 0s;">
    <div class="section-banner" style="">
        ...
        <p class="section-banner-title">Challenges</p>
        <!-- /SECTION BANNER TITLE -->
        <!-- SECTION BANNER TEXT -->
        <p class="section-banner-text">Compete with users world wide activists in order to make the planet green again!</p>
        <!-- /SECTION BANNER TEXT -->
    </div>

</div>
<div class="grid grid-3-3-3-3 centered" style="
    max-width: 70vw;
    margin-left: 15vw;
">
<?php
...
?>
  <div class="quest-item">
        <!-- QUEST ITEM COVER -->
        <a href="/challenge/<?=$challenge->idChallenge?>">
        <figure class="quest-item-cover liquid" style="background: url(&quot;<?=$challenge->cover?>&quot;) center center / cover no-repeat;">
          <img src="<?=$challenge->cover?>" alt="cover-02" style="display: none;">
        </figure>
        </a>
        <!-- /QUEST ITEM COVER -->
        ...
        <div class="quest-item-info">
          ...
          <div class="quest-item-badge">
            <img src="/public/img/quest/completedq-b.png" alt="completedq-b">
          </div>
          <!-- /QUEST ITEM BADGE -->
          <a href="/challenge/<?=$challenge->idChallenge?>">
    
          <!-- QUEST ITEM TITLE -->
          <p class="quest-item-title"><?=$challenge->title?></p>
          <!-- /QUEST ITEM TITLE -->
    </a>
          <!-- QUEST ITEM TEXT -->
          <a href="/challenge/<?=$challenge->idChallenge?>">
    
          <p class="quest-item-text">
          <?=substr($challenge->description,0, 100)?>
          <br/>- By Company <?=$challenge->getCompany()->name?></p>
          </a>
          <!-- /QUEST ITEM TEXT -->
          <a href="/challenge/<?=$challenge->idChallenge?>">Read More</a>
